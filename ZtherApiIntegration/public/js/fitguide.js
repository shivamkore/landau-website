$(function () {
    ...
    $('#video_overlay').on('click', function () {
        ...
        $('#options').children(".col-md-4").on('click', function(){
            ...
            $('#full-size').children('#'+classer +'-coat-chart').addClass('active');
            $('#mobile').children('#'+classer +'-coat-chart').addClass('active');
            if(classer == 'men'){
        ...
        if(gender == 'men'){
            ...
            if(types == 'pants clothing'){
                ...
                if(fit == 'classic style'){
                    ...
                    var nextrowinfo = '<div class="urbane_logo"><img id="logo" src="public/images/fit-guide/urbane_logo.svg" width="10%" height="auto"></div><div class="col-xs-0 col-sm-3 col-md-3"></div><div class="col-xs-6 col-sm-3 col-md-3"><a href="http://www.urbanescrubs.com/9534-womens-double-pocket-crossover-top"><img src="public/images/fit-guide/9534.jpeg"></a><div class="description">Womens Double Pocket Crossover Top</div><div class="number">9534</div></div><div class="col-xs-6 col-sm-3 col-md-3"></div><div class="col-xs-6 col-sm-3 col-md-3"></div>';
                    update_rowinfo(nextrowinfo, 'urbane');
                    ...
                    var nextrowinfo = '<div class="urbane_logo"><img id="logo" src="public/images/fit-guide/urbane_logo.svg" width="10%" height="auto"></div><div class="col-xs-0 col-sm-3 col-md-3"></div><div class="col-xs-6 col-sm-3 col-md-3"><a href="http://www.urbanescrubs.com/9047-womens-quick-cool-sport-tunic"><img src="public/images/fit-guide/9047.jpeg"></a><div class="description">Womens Quick Cool Sport Tunic</div><div class="number">9047</div></div><div class="col-xs-6 col-sm-3 col-md-3"><a href="http://www.urbanescrubs.com/9577-womens-sophie-crossover-tunic"><img src="public/images/fit-guide/9577.jpeg"></a><div class="description">Womens Sophie Crossover Tunic</div><div class="number">9577</div></div><div class="col-xs-6 col-sm-3 col-md-3"></div>';
                ...
                add_content(output);
                    ...
                    var nextrowinfo = '<div class="urbane_logo"><img id="logo" src="public/images/fit-guide/urbane_logo.svg" width="10%" height="auto"></div><div class="col-xs-0 col-sm-3 col-md-3"></div><div class="col-xs-6 col-sm-3 col-md-3"><a href="http://www.urbanescrubs.com/9063-chelsea-soft-v-neck-tunic"><img src="public/images/fit-guide/9063-large.jpg" width="60%"></a><div class="description">"Chelsea" Soft V-Neck Tunic</div><div class="number">9063</div></div><div class="col-xs-6 col-sm-3 col-md-3"><a href="http://www.urbanescrubs.com/9062-leah-empire-notch-neck-tunic"><img src="public/images/fit-guide/9062.jpg" width="60%"></a><div class="description">"Leah" Empire Notch Neck Tunic</div><div class="number">9062</div></div><div class="col-xs-6 col-sm-3 col-md-3"></div>';
                    update_rowinfo(nextrowinfo, 'urbane');
