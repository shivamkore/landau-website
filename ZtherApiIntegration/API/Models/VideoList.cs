...
namespace ZtherApiIntegration.API.Models
{
    public partial class VideoList
    {
        ...
        private IList<Video> _results;
        
        /// <summary>
        /// Optional.
        /// </summary>
        public IList<Video> Results
        {
        ...
        /// <summary>
        /// Initializes a new instance of the VideoList class.
        /// </summary>
        public VideoList()
        {
            this.Results = new LazyList<Video>();
        }
            ...
            if (inputObject != null && inputObject.Type != JTokenType.Null)
            {
                ...
                if (resultsSequence != null && resultsSequence.Type != JTokenType.Null)
                {
                    foreach (JToken resultsValue in ((JArray)resultsSequence))
                    {
                        ...
                        video.DeserializeJson(resultsValue);
