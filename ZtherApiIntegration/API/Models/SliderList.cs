...
namespace ZtherApiIntegration.API.Models
{
    public partial class SliderList
    {
        ...
        private IList<Slider> _results;
        
        /// <summary>
        /// Optional.
        /// </summary>
        public IList<Slider> Results
        {
        ...
        /// <summary>
        /// Initializes a new instance of the SliderList class.
        /// </summary>
        public SliderList()
        {
            this.Results = new LazyList<Slider>();
        }
            ...
            if (inputObject != null && inputObject.Type != JTokenType.Null)
            {
                ...
                if (resultsSequence != null && resultsSequence.Type != JTokenType.Null)
                {
                    foreach (JToken resultsValue in ((JArray)resultsSequence))
                    {
                        ...
                        slider.DeserializeJson(resultsValue);
                        this.Results.Add(slider);
                    }
                }
            }
        }
