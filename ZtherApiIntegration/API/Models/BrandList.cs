...
namespace ZtherApiIntegration.API.Models
{
    public partial class BrandList
    {
        ...
        private IList<Brand> _results;
        
        /// <summary>
        /// Optional.
        /// </summary>
        public IList<Brand> Results
        {
        ...
        /// <summary>
        /// Initializes a new instance of the BrandList class.
        /// </summary>
        public BrandList()
        {
            this.Results = new LazyList<Brand>();
        }
            ...
            if (inputObject != null && inputObject.Type != JTokenType.Null)
            {
                ...
                if (resultsSequence != null && resultsSequence.Type != JTokenType.Null)
                {
                    foreach (JToken resultsValue in ((JArray)resultsSequence))
                    {
                        ...
                        brand.DeserializeJson(resultsValue);
                        this.Results.Add(brand);
                    }
                }
            }
        }
