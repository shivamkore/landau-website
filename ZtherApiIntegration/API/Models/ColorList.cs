...
namespace ZtherApiIntegration.API.Models
{
    public partial class ColorList
    {
        ...
        private IList<Color> _results;
        
        /// <summary>
        /// Optional.
        /// </summary>
        public IList<Color> Results
        {
        ...
        /// <summary>
        /// Initializes a new instance of the ColorList class.
        /// </summary>
        public ColorList()
        {
            this.Results = new LazyList<Color>();
        }
            ...
            if (inputObject != null && inputObject.Type != JTokenType.Null)
            {
                ...
                if (resultsSequence != null && resultsSequence.Type != JTokenType.Null)
                {
                    foreach (JToken resultsValue in ((JArray)resultsSequence))
                    {
                        ...
                        color.DeserializeJson(resultsValue);
