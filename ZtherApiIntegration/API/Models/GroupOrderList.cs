...
namespace ZtherApiIntegration.API.Models
{
    public partial class GroupOrderList
    {
        ...
        private IList<GroupOrder> _results;
        
        /// <summary>
        /// Optional.
        /// </summary>
        public IList<GroupOrder> Results
        {
        ...
        /// <summary>
        /// Initializes a new instance of the GroupOrderList class.
        /// </summary>
        public GroupOrderList()
        {
            this.Results = new LazyList<GroupOrder>();
        }
            ...
            if (inputObject != null && inputObject.Type != JTokenType.Null)
            {
                ...
                if (resultsSequence != null && resultsSequence.Type != JTokenType.Null)
                {
                    foreach (JToken resultsValue in ((JArray)resultsSequence))
                    {
                        ...
                        groupOrder.DeserializeJson(resultsValue);
                        this.Results.Add(groupOrder);
                    }
                }
            }
        }
