...
namespace ZtherApiIntegration.API.Models
{
    public partial class CountryList
    {
        ...
        private IList<Country> _results;
        
        /// <summary>
        /// Optional.
        /// </summary>
        public IList<Country> Results
        {
        ...
        /// <summary>
        /// Initializes a new instance of the CountryList class.
        /// </summary>
        public CountryList()
        {
            this.Results = new LazyList<Country>();
        }
            ...
            if (inputObject != null && inputObject.Type != JTokenType.Null)
            {
                ...
                if (resultsSequence != null && resultsSequence.Type != JTokenType.Null)
                {
                    foreach (JToken resultsValue in ((JArray)resultsSequence))
                    {
                        ...
                        country.DeserializeJson(resultsValue);
                        this.Results.Add(country);
                    }
                }
            }
        }
