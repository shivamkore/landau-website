...
namespace ZtherApiIntegration.API.Models
{
    public partial class TileList
    {
        ...
        private IList<Tile> _results;
        
        /// <summary>
        /// Optional.
        /// </summary>
        public IList<Tile> Results
        {
        ...
        /// <summary>
        /// Initializes a new instance of the TileList class.
        /// </summary>
        public TileList()
        {
            this.Results = new LazyList<Tile>();
        }
        ...
        public virtual void DeserializeJson(JToken inputObject)
        {
            if (inputObject != null && inputObject.Type != JTokenType.Null)
            {
                ...
                if (resultsSequence != null && resultsSequence.Type != JTokenType.Null)
                {
                    ...
                    {
                        Tile tile = new Tile();
                        tile.DeserializeJson(resultsValue);
                        this.Results.Add(tile);
                    }
                }
            }
        }
