...
namespace ZtherApiIntegration.API.Models
{
    public partial class SizeList
    {
        ...
        private IList<Size> _results;
        
        /// <summary>
        /// Optional.
        /// </summary>
        public IList<Size> Results
        {
        ...
        /// <summary>
        /// Initializes a new instance of the SizeList class.
        /// </summary>
        public SizeList()
        {
            this.Results = new LazyList<Size>();
        }
        ...
        public virtual void DeserializeJson(JToken inputObject)
        {
            if (inputObject != null && inputObject.Type != JTokenType.Null)
            {
                ...
                if (resultsSequence != null && resultsSequence.Type != JTokenType.Null)
                {
                    ...
                    {
                        Size size = new Size();
                        size.DeserializeJson(resultsValue);
                        this.Results.Add(size);
                    }
                }
            }
        }
