...
namespace ZtherApiIntegration.API.Models
{
    public partial class SignUpList
    {
        ...
        private IList<SignUp> _results;
        
        /// <summary>
        /// Optional.
        /// </summary>
        public IList<SignUp> Results
        {
        ...
        /// <summary>
        /// Initializes a new instance of the SignUpList class.
        /// </summary>
        public SignUpList()
        {
            this.Results = new LazyList<SignUp>();
        }
            ...
            if (inputObject != null && inputObject.Type != JTokenType.Null)
            {
                ...
                if (resultsSequence != null && resultsSequence.Type != JTokenType.Null)
                {
                    foreach (JToken resultsValue in ((JArray)resultsSequence))
                    {
                        ...
                        signUp.DeserializeJson(resultsValue);
                        this.Results.Add(signUp);
                    }
                }
            }
        }
