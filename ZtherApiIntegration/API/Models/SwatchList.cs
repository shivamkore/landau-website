...
{
    public partial class SwatchList
    {
        private int? _count;
        ...
        private IList<Swatch> _results;
        
        /// <summary>
        /// Optional.
        /// </summary>
        public IList<Swatch> Results
        {
        ...
        /// <summary>
        /// Initializes a new instance of the SwatchList class.
        /// </summary>
        public SwatchList()
        {
            this.Results = new LazyList<Swatch>();
        }
            ...
            if (inputObject != null && inputObject.Type != JTokenType.Null)
            {
                ...
                if (resultsSequence != null && resultsSequence.Type != JTokenType.Null)
                {
                    foreach (JToken resultsValue in ((JArray)resultsSequence))
                    {
                        ...
                        swatch.DeserializeJson(resultsValue);
                        this.Results.Add(swatch);
                    }
                }
            }
        }
