...
{
    internal partial class SignUps : IServiceOperations<LandauPortalWebAPI>, ISignUps
    {
        /// <summary>
        /// Initializes a new instance of the SignUps class.
        /// </summary>
        /// <param name='client'>
        /// Reference to the service client.
        /// </param>
        internal SignUps(LandauPortalWebAPI client)
        {
            this._client = client;
        }
        ...
        /// Cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<string>> CreateSignUpsInSalesforceResponseAsync(string brand, SignUp model, CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // Validate
            if (brand == null)
            {
        ...
        /// Cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<SignUp>> GetSignUpsByIdWithOperationResponseAsync(string brand, int id, CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // Validate
            if (brand == null)
            {
            ...
            if (shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(invocationId, this, "GetSignUpsByIdAsync", tracingParameters);
            }
            ...
            // Create Result
            HttpOperationResponse<SignUp> result = new HttpOperationResponse<SignUp>();
            result.Request = httpRequest;
            result.Response = httpResponse;
