...
{
    internal partial class Cache : IServiceOperations<LandauPortalWebAPI>, ICache
    {
        /// <summary>
        ...
        /// </param>
        internal Cache(LandauPortalWebAPI client)
        {
            this._client = client;
        }
        ...
        /// Cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<string>> DeleteWithOperationResponseAsync(CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // Tracing
        ...
        /// Cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<string>> DeleteCacheByKeyWithOperationResponseAsync(string key, CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // Validate
            if (key == null)
            {
            ...
            if (shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(invocationId, this, "DeleteCacheByKeyAsync", tracingParameters);
            }
