...
{
    internal partial class Brands : IServiceOperations<LandauPortalWebAPI>, IBrands
    {
        /// <summary>
        /// Initializes a new instance of the Brands class.
        /// </summary>
        /// <param name='client'>
        /// Reference to the service client.
        /// </param>
        internal Brands(LandauPortalWebAPI client)
        {
            this._client = client;
        }
        ...
        /// Cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<Brand>> GetBrandByCodeAsyncWithOperationResponseAsync(string code, CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // Validate
            if (code == null)
            {
            ...
            if (shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(invocationId, this, "GetBrandByCodeAsyncAsync", tracingParameters);
            }
            ...
            // Create Result
            HttpOperationResponse<Brand> result = new HttpOperationResponse<Brand>();
            result.Request = httpRequest;
            result.Response = httpResponse;
