$(function () {
    ...
    function redirecttofit(externalLink) {
        ...
        if (externalLink=='urbane') {
            window.location.href = "http://urbanescrubs-staging.azurewebsites.net/" + redirectUrl.gender + '/category/' + redirectUrl.types + '?fit=' + redirectUrl.fit;
        }
        else if (externalLink == 'smitten') {
            window.location.href = "http://smittenscrubs-staging.azurewebsites.net/" + redirectUrl.gender + '/collection/' + redirectUrl.types + '?fit=' + redirectUrl.fit;
        }
        else {
...
console.log(types);
		...
		if(gender == 'men'){
			...
			if(types == 'pants clothing'){
				...
				var rowinfo = '<div class="landau_logo"><img id="logo" src="public/images/fit-guide/landau_logo2.png"></div><div class="col-xs-0 col-sm-3 col-md-3"></div><div class="col-xs-6 col-sm-3 col-md-3"><img src="public/images/fit-guide/8335.jpeg"><div class="description">Womens Natural Flare Leg Pant</div><div class="number">8335</div></div><div class="col-xs-6 col-sm-3 col-md-3"><img src="public/images/fit-guide/8327.jpeg"><div class="description">Womens Classic Relaxed Pant</div><div class="number">8327</div></div><div class="col-xs-6 col-sm-3 col-md-3"></div>';
					update_rowinfo(rowinfo, 'landau');

					var nextrowinfo = '<div class="urbane_logo"><img id="logo" src="public/images/fit-guide/urbane_logo.svg" width="10%" height="auto"></div><div class="col-xs-0 col-sm-3 col-md-3"></div><div class="col-xs-6 col-sm-3 col-md-3"><img src="public/images/fit-guide/9502.jpeg"><div class="description">Womens Relaxed Drawstring Pant</div><div class="number">9502</div></div><div class="col-xs-6 col-sm-3 col-md-3"></div><div class="col-xs-6 col-sm-3 col-md-3"></div>';
					...
					var rowinfo = '<div class="landau_logo"><img id="logo" src="public/images/fit-guide/landau_logo2.png"></div><div class="col-xs-0 col-sm-3 col-md-3"></div><div class="col-xs-6 col-sm-3 col-md-3"><img src="public/images/fit-guide/2035.jpeg"><div class="description">Womens All Day Full Elastic Cargo Pant</div><div class="number">2035</div></div><div class="col-xs-6 col-sm-3 col-md-3"><img src="public/images/fit-guide/2024.jpeg"><div class="description">Womens Pre-Washed Cargo Pant</div><div class="number">2024</div></div><div class="col-xs-6 col-sm-3 col-md-3"></div>';
					update_rowinfo(rowinfo, 'landau');

					var nextrowinfo = '<div class="urbane_logo"><img id="logo" src="public/images/fit-guide/urbane_logo.svg" width="10%" height="auto"></div><div class="col-xs-0 col-sm-3 col-md-3"></div><div class="col-xs-6 col-sm-3 col-md-3"><img src="public/images/fit-guide/9324.jpeg"><div class="description">Womens Knit Waist Cargo Jogger Pant</div><div class="number">9324</div></div><div class="col-xs-6 col-sm-3 col-md-3"><img src="public/images/fit-guide/9306.jpeg"><div class="description">Womens Alexis Comfort Elastic Waist Pant</div><div class="number">9306</div></div><div class="col-xs-6 col-sm-3 col-md-3"></div>';
					update_rowinfo(nextrowinfo, 'urbane');
				}
				else{
				...
				add_content(output);
				var nextrowinfo = '<div class="urbane_logo"><img id="logo" src="public/images/fit-guide/urbane_logo.svg" width="10%" height="auto"></div><div class="col-xs-0 col-sm-3 col-md-3"></div><div class="col-xs-6 col-sm-3 col-md-3"><img src="public/images/fit-guide/9329.jpeg" width="200px" height="auto"><div class="description">"Taylor" Straight Leg Pant</div><div class="number">9329</div></div><div class="col-xs-6 col-sm-3 col-md-3"><img src="public/images/fit-guide/9330-large.jpg" width="60%"><div class="description">"Michelle" Yoga Flare Leg Pant</div><div class="number">9330</div></div><div class="col-xs-6 col-sm-3 col-md-3"></div>';
					update_rowinfo(nextrowinfo, 'urbane');
					var rowinfo = '<div class="smitten_logo"><img id="logo" src="public/images/fit-guide/smitten_logo.svg" width="10%" height="auto"></div><div class="col-xs-0 col-sm-3 col-md-3"></div><div class="col-xs-6 col-sm-3 col-md-3"><img src="public/images/fit-guide/s201003.jpeg" width="90%"><div class="description">AMP- Womens Smitten Cargo Elastic Pant</div><div class="number">S201003</div></div><div class="col-xs-6 col-sm-3 col-md-3"><img src="public/images/fit-guide/s201002.jpeg" width="90%"><div class="description">Hottie - Womens Smitten Pant</div><div class="number">S201002</div></div><div class="col-xs-6 col-sm-3 col-md-3"></div>';
				...
				add_content(output);
					...
					// <div class="col-md-3"><img src="public/images/fit-guide/9062.jpg" width="100%"><div class="description">"Leah" Empire Notch Neck Tunic</div><div class="number">9062</div></div>
					update_rowinfo(nextrowinfo, 'urbane');
